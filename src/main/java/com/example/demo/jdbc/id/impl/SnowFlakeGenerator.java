package com.example.demo.jdbc.id.impl;

import java.util.ArrayList;
import java.util.List;

import com.example.demo.jdbc.id.IdGenerator;
...
public class SnowFlakeGenerator implements IdGenerator {
	...
	public List<String> generateIdList(int count) {
		// TODO Auto-generated method stub
		List<String> generateIdList=new ArrayList<>();
		generateIdList.forEach(integer -> {
			generateIdList.add(String.valueOf(nextId()));
		});
