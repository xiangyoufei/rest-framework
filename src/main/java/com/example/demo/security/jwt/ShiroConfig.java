...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager getManager(@Qualifier("jwtRealm") JWTRealm realm) {
...
//        filterRuleMap.put("login", "anon");
 ...
 /*   
  //配置自定义的权限登录器
  	@Bean(name="jwtRealm")
  	public JWTRealm authRealm(@Qualifier("credentialsMatcher") JWTCredentialsMatcher matcher) {
